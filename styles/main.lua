...
data.raw["gui-style"].default["als_location_view"] =
{
    ...
    {
        filename = "__advanced-logistics-system-2__/graphics/location.png",
        priority = "extra-high-no-scale",
        width = 100,
        height = 100,
        x = 0
    ...
    hovered_graphical_set =
    {
            ...
            filename = "__advanced-logistics-system-2__/graphics/location-hover.png",
            priority = "extra-high-no-scale",
            width = 100,
            height = 100,
            x = 0
...
data.raw["gui-style"].default["als_button"] =
{
    ...
    default_graphical_set =
    {
            ...
            filename = "__advanced-logistics-system-2__/graphics/gui.png",
            priority = "extra-high-no-scale",
            width = 32,
            height = 32,
            x = 0
